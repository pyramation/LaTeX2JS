...
var pspicture = exports.pspicture = function (_Component) {
  ...
  function pspicture() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = pspicture.__proto__ || Object.getPrototypeOf(pspicture)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      // loaded: false,
